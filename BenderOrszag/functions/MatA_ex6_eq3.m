%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                   %
%   CARLEMAN MatA_ex6_eq3.-                                         %
%   jc.munoz@csic.es                                                %
%   2023                                                            %
%                                                                   %               
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [A,Vars,X_0] = MatA_ex6_eq3(N,a,b)
    ...
    for w = 1:length(Vars)
        i = E(w,1);
        j = E(w,2);
        eqs(w,1) = (-3*i+2*j)*str2sym("x"+num2str(i)+num2str(j)) + (j+i)*str2sym("x"+num2str(i+1)+ num2str(j))...
            +2*j*str2sym("x"+num2str(i+1)+num2str(j-1))+(j-i)*str2sym("x"+num2str(i)+num2str(j+1));               
    end    
