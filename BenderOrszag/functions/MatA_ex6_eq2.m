%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                   %
%   CARLEMAN MatA_ex6_eq2.-                                         %
%   jc.munoz@csic.es                                                %
%   2023                                                            %
%                                                                   %               
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [A,Vars,X_0] = MatA_ex6_eq2(N,a,b)
    ...
    for w = 1:length(Vars)
        i = E(w,1);
        j = E(w,2);
        eqs(w,1) = (i-j)*str2sym("x"+num2str(i)+num2str(j)) + (j+i)*str2sym("x"+num2str(i+1)+ num2str(j))...
           + (j-i)*str2sym("x"+num2str(i)+num2str(j+1))-i*str2sym("x"+num2str(i-1)+num2str(j+1));               
    end    
